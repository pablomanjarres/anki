...
export type RejectionReason = { index: number; reason: string };
export type Submission = { runKey: string; date: string; cards: CardInput[]; rejections?: RejectionReason[] };
export type SubmissionResult = { created: number; duplicates: number; rejected: number; paused: boolean; cardIds: string[]; rejectionReasons?: RejectionReason[] };
